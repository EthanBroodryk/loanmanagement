...
@include('sweetalert::alert')
	...
	<header class="header-section">
		...
		<h3><span style="color: white;">LOAN </span><span style="color:royalblue">LEVERAGE</span></h3>
		</a>
		<nav class="header-nav">
			...
			<div class="header-right">
				...
				<div class="hr-btn hr-btn-2">0812676774</div>
			</div>
		</nav>
	</header>
	<!-- Header Section end -->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-7">
					<div class="info-text">
						<ul>
							<li style="color:royalblue">0812676774</li>
							<li style="color:royalblue">broodrykethan349@gmail.com</li>
						</ul>
					</div>
				</div>
			</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved <strong>LeverageLoan</strong>
